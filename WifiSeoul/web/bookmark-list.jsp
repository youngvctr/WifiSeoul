            ...
            <table>
                ...
                <c:forEach var="bookmark" items="${bookmark}">
                    <tr>
                        ...
                        <td>${bookmark.getUpdate_date()}</td>
                        <td>
                            <form action="<%= request.getContextPath()%>/bookmark-delete.jsp" method="get">
                                ...
                                <input type="hidden" name="reg_date" value="${bookmark.getRegister_date()}">
                                <input type="hidden" name="main_nm" value="${bookmark.getMain_nm()}">
                                <input type="submit" value="Delete">
                            </form>

                            <form action="<%= request.getContextPath()%>/bookmark-edit.jsp" method="get">
                                <input type="hidden" name="id" value="${bookmark.getId()}">
                                <input type="hidden" name="name" value="${bookmark.getBookmark_name()}">
                                <input type="hidden" name="order" value="${bookmark.getBookmark_order()}">
                ...
                <c:if test="${empty bookmark}">
                    <tr>
                        <td style="text-align: center">북마크 목록이 없습니다.</td>
                    </tr>
                </c:if>
                </tbody>
            </table>
